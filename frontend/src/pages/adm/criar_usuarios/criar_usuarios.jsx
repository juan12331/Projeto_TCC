  ...
  const regexMaisDe14Caracteres = /^.{15,}$/
    ...
    function formatCPF(cpf) {
      ...
      async function Criar(e) {
        ...
        await createUser(cpf, nome, email, senha, tel, papel).then(data => {
        ...
        <div className="criarUser_page">
            ...
            <div className="fundo-criarUser">
                        ...
                        <div className="grid-criarUser">
                            ...
                            <form className="itensRight-criarUser">
                                ...
                                <div className="text-criarUser">
                                    <select className="itensText-criarUser" defaultValue="" required>
              ...
              <span className='error' id='span'></span>
                        ...
                        <button onClick={(e) => Criar(e)} className="cadastrarUser-button">Cadastrar</button>
                    </div>
                </div>
