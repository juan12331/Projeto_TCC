...
Clone este repositório: git clone https://github.com/juan12331/Projeto_TCC.git 

Navegue para o Diretório do Projeto: cd Projeto_TCC 

Para acessar a pasta Frontend: cd frontend 

Para acessar a pasta Backend: cd backend 

Instale as Dependências: npm i 

Rodar código na pasta Frontend: npm run dev 

Rodar código na pasta Backend: noder server.js  
...
sequelize.js: Arquivo de configuração do Sequelize ORM, responsável por estabelecer a conexão com o banco de dados e definir parâmetros de operação. 
